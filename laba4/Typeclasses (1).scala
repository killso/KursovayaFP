...
object Typeclasses {
  ...
  def main(args: Array[String]): Unit = {
    println(Typeclasses.testReversableString("abcdefgh"))
    println(Typeclasses.testSmashInt(1, 2))
    println(Typeclasses.testSmashDouble(1.4, 1.9))
    println(Typeclasses.testSmashString("Микро", "Мир"))
  }
}