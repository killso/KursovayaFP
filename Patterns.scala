...
object PatternMatching {
  ...
  def winsA(a: Hand, b: Hand): Result = {
    a match {
      case "Rock" => b == "Paper"
      case "Scissors" => b == "Rock"
      case "Paper" => b == "Scissors"
    }
  }
  ...
  def retWeight(animal: Animal):Int = if animal.weight>=0 animal.weight else -1
  ...
  {
    Animal.fish.food = "plants"
    Animal.bird.food = "plants"
    Animal
  }
